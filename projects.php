...
<html lang="en">
  <head>
    ...
    <title>Community Connectors - Open Projects</title>
  </head>
  <body>
  ...
  <nav class="navbar navbar-dark navbar-expand-sm bg-dark fixed-top">
    ...
    <div class="project-box-wrapper mt-5 mx-auto">
        <h1 id="header-padding" class="text-center">Open Projects</h1>
        <div class="table table-responsive">
            ...
            <tbody>
                ...
                $sql = "SELECT user_id, project_id FROM user_has_project WHERE role = ?";
                ...
                if($stmt = mysqli_prepare($c, $sql)){
                    ...
                    if(mysqli_stmt_execute($stmt)){
                        ...
                        while($row = $stmt_result->fetch_assoc()) {
                            ...
                            $sql = "SELECT company_name FROM user_has_company WHERE user_id = ?";
                            if($stmt = mysqli_prepare($c, $sql)){
                                ...
                                if(mysqli_stmt_execute($stmt)){
                                    ...
                                    $company_name = $stmt->get_result()->fetch_object()->company_name;
                                    // Close statement
                                    mysqli_stmt_close($stmt);
                                    ...
                                    if($stmt = mysqli_prepare($c, $sql)){
                                        ...
                                        if(mysqli_stmt_execute($stmt)){
                                            ...
                                            echo "<td>" . create_short_description($project->description, 30) . "</td>";
                                            ...
                                            echo '<td> <a role="button" class="btn btn-outline-primary" href="./project/signup.php?id=' . $project_id . '">Sign Up</a> </td>';
                                            echo "</tr>";
